        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-800 shrink-0">
          ...
          <div className="flex -space-x-1.5 ml-1">
            {party.members.slice(0, 5).map(m => (
              <img key={m.id} src={m.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(m.display_name || 'U')}&background=8b5cf6&color=fff&size=32`} className="w-6 h-6 rounded-lg border border-zinc-900 object-cover" title={m.display_name} alt="" />
            ))}
          ...
          <div className="space-y-1.5 max-h-40 overflow-y-auto">
            {party.members.map(m => (
              <div key={m.id} className="flex items-center gap-2">
                <img src={m.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(m.display_name || 'U')}&background=8b5cf6&color=fff&size=32`} className="w-6 h-6 rounded-lg object-cover shrink-0" alt="" />
