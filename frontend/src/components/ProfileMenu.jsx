...
export default function ProfileMenu({ compact = false }) {
  ...
  return (
    <div className="relative" ref={rootRef}>
      <button
        onClick={() => setOpen(v => !v)}
        className={`flex items-center gap-2.5 rounded-xl transition-all ${compact ? 'p-1 hover:bg-zinc-100 dark:hover:bg-white/5' : 'py-1.5 pl-1.5 pr-3 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-md hover:border-zinc-300 dark:hover:border-zinc-700'}`}
      >
