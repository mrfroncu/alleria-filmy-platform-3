        ...
        <div className="absolute z-50 mt-2 w-[320px] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl shadow-zinc-900/20 dark:shadow-black/40 overflow-hidden" style={{ animation: 'slideUp 0.2s ease-out' }}>
          ...
          <div className="border-t border-zinc-200 dark:border-zinc-800 px-4 py-3 flex items-center gap-2">
            ...
            <input
              ...
              className="w-12 px-2 py-1.5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg text-center font-mono text-sm font-bold text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
              placeholder="GG"
            />
            ...
            <button
              ...
              className="ml-auto text-[11px] font-bold text-indigo-500 hover:text-indigo-400 transition-colors"
            >
              Teraz
            </button>
          </div>
