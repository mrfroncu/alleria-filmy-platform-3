              ...
              <div className="p-4 bg-zinc-800 rounded-2xl space-y-2">
                ...
                {party.members.map(m => (
                  <div key={m.id} className="flex items-center gap-2.5">
                    <img src={m.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(m.display_name || 'U')}&background=8b5cf6&color=fff&size=40`} className="w-7 h-7 rounded-lg object-cover shrink-0" alt="" />
