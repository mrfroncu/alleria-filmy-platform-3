  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 min-h-screen bg-zinc-50 dark:bg-zinc-950 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="aurora-blob aurora-1 -top-40 -left-40 w-[480px] h-[480px] bg-violet-600/15 dark:bg-violet-600/20 blur-[130px]" />
        <div className="aurora-blob aurora-2 -bottom-40 -right-40 w-[480px] h-[480px] bg-fuchsia-600/10 dark:bg-fuchsia-600/15 blur-[130px]" />
      </div>
